...
public class TablutOurClient extends TablutClient {
	...
	public TablutOurClient(String player, String name, int gameChosen, int timeout, String ipAddress) throws UnknownHostException, IOException {
		super(player, name, timeout, ipAddress);
		game = gameChosen;
	}
	
	public TablutOurClient(String player, String name, int timeout, String ipAddress) throws UnknownHostException, IOException {
		...
		while (true) {
			...
			if (this.getPlayer().equals(Turn.WHITE)) {
				...
				if (this.getCurrentState().getTurn().equals(StateTablut.Turn.WHITE)) {
					...
					// Trova una mossa a caso, prendendo un pezzo casuale e scegliendo una mossa casuale per quel pezzo
					while (!found) {
						if (pawns.size() > 1) {
